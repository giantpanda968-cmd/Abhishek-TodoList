...
const Feed = () => {
  ...
  const gettask = async () => {
    try {
      const res = await axios.get("https://abhishek-todolist.onrender.com/api/user/task");
  ...
  const deleteTask = async (id) => {
    try {
      const res = await axios.delete(
        `https://abhishek-todolist.onrender.com/api/user/task/${id}`,
      );
  ...
  const allTaskdelete = async () => {
    try {
      const res = await axios.delete("https://abhishek-todolist.onrender.com/api/user/task");
      toast.success(res.data.message);
      setUserTask([]);
    } catch (error) {
      console.log(error);
